...
VENDORED COPY: this file is an exact copy of the engine in the sibling
slop-scanner project, vendored here so eval-mcp-server is self-contained and
stdlib-only. Keep in sync if the upstream engine changes.
"""
